              ...
              <ul className="list-group list-group-separated">
                <li className="list-group-item py-4">
                  <p className="text-muted lead">
                    ...
                    focus on innovation, quality, and reliability. Whether
                    you're purchasing your first car or returning for another,
                    we are here to ensure your experience is seamless and
